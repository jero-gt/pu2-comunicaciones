...
xticks([-12e3, -8e3, -4e3, 0, 4e3, 8e3, 12e3]);xticklabels({'-12', '-8','-4', '0', '4', '8', '12'});xlabel("f[KHz]");
...
x1=filter(LP,z);
plotCompleto([0 n(end)./fs -0.5 0.5], 't[s]', '', 'audio1', 20, 'b',0.5, n./fs, x1);
